...
const Table = ({todos, setTodos, isLoading}) => {
    ...
    const handleDelete = async (id) => {
        try{
            ...
            const newList = todos.filter(todo => todo.id === id ? response.data : todo)
            setTodos(newList)
        } catch (error){
            console.log(error);
        }
    ...
    <div className=' py-2'>
        ...
        <div className="modal" role="dialog">
            <div className="modal-box">
                ...
                <input type="text" value={editText.body} placeholder="Type here" onChange={handleChange} className="input input-bordered w-full mt-8" />
